...
#define USB_CDC_PRODUCT_ID  0x374b
#define USB_CDC_EP_IN       0x85   // Endpoint address for IN direction
#define USB_CDC_EP_OUT      0x05    // Endpoint address for OUT direction
#define USB_CDC_BUFSIZE      16   // Buffer size for data transfers
...
static char data[USB_CDC_BUFSIZE] = "LED_ON";
